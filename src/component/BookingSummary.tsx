    ...
    <View style={styles.container}>
      ...
      <View>
         ...
         <View style={{flexDirection:'row'}}>
           <Text style={{fontFamily: 'serif', fontWeight: '600', fontSize: 18,color:"black"}}>
             Name:
           </Text>
      ...
      <View style={styles.detailsContainer}>
        {userDetails.map((item:any, index:number) => (
          <View key={index} style={styles.bookingBox} >
             <TouchableOpacity  onPress={()=>onHandleCross(index)}><Image source={require("../assets/images/icons/icons8-cross-50.png")} style={{position:'relative',top:4,left:74,height:20,width:20,tintColor:"red",marginTop:-10,marginLeft:250}} /></TouchableOpacity>  
            <View style={{flexDirection:"row"}}>
      ...
      <Text style={{textAlign:"center",color:"white",fontWeight:"600",backgroundColor:"blue",borderRadius:5,paddingVertical:10,marginTop:20}}>Pay Now</Text>
    </View>
  );
};
