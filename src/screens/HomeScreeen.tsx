        ...
        <View style={styles.a}>
          ...
          <View>
            <TouchableOpacity onPress={toggleModal}>
              ...
              <View style={{}}>
                <Image
                  source={require('../assets/images/icons/menu-bar.png')}
                  style={{
                    height: 30,
                    width: 30,
                    marginLeft: 120,
              ...
              <View
                ...
                <View style={{flexDirection: 'row', marginTop: 10}}>
                  <Image
                    ...
                    style={{height: 20, width: 20, margin: 11}}
                  />

                  <Text
                    style={{color: 'black', paddingTop: 10, marginLeft: -7}}>
                    Akash
                  </Text>
                ...
                <TouchableOpacity onPress={handleLogout}>
                  <View style={{flexDirection: 'row', marginLeft: 8}}>
                    <Image
                      source={require('../assets/images/icons/icons8-logout-48.png')}
                      style={{height: 20, width: 20, marginLeft: 4}}
                    />
                    <Text style={{fontWeight: '900', marginLeft: 2}}>
                      Logout
                    </Text>
                  </View>
                </TouchableOpacity>
        ...
        <View style={{marginTop: 10}}>
          <View
            ...
            <Text
              ...
              Please Select the Latest Tour Package!!!
            </Text>
          </View>
        </View>
